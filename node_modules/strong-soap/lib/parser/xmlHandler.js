...
var XMLHandler = function () {
  function XMLHandler(schemas, options) {
  ...
  _createClass(XMLHandler, [{
    ...
    key: 'getXsiType',
    value: function getXsiType(descriptor, attrs) {
    ...
    key: '_sortKeys',
    value: function _sortKeys(val, elementOrder) {
      function compare(n1, n2, order) {
        var i1 = order.indexOf(n1);
        if (i1 === -1) i1 = order.length;
        var i2 = order.indexOf(n2);
        if (i2 === -1) i2 = order.length;
        return i1 - i2;
      }
      var keys = Object.keys(val);
      var names = [].concat(keys).sort(function (n1, n2) {
        var result = compare(n1, n2, elementOrder);
        if (result === 0) {
    ...
    value: function mapObject(node, nsContext, descriptor, val, attrs) {
      ...
      if (!Array.isArray(val)) {
        var names = this._sortKeys(val, elementOrder);
